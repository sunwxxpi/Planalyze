...
save_dir = f"./runs/segment/SPA/{current_time}"
...
# SPA Classes
classes = [0, 1, 2, 12, 13, 14, 15, 16, 17, 18, 19, 21, 22]
...
model = YOLO(f"{save_dir}/exp/SPA/weights/best.pt")  # 훈련된 모델 로드
