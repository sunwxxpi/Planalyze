...
BATCH_SIZE = 2
IMAGE_SIZE = 2080
RESULT_DIR = f"./results/STR/{datetime.now().strftime('%Y%m%d_%H%M%S')}"
TARGET_CLASSES = [8, 9, 10] # STR Classes
GPU_DEVICE = 1
...
with open(results_file_path, 'w', encoding='utf-8') as f:
    f.write(f"YOLO v11 STR Segmentation Performance Results\n")
