...
# 프로젝트 설정
RESULT_DIR = "/home/work/.Planalyze/Planalyze/results/SPA/20250907_020057"
TARGET_CLASSES = [0, 1, 2, 12, 13, 14, 15, 16, 17, 18, 19, 21, 22]
IMAGE_SIZE = 2080
...
COLORS = [
    ...
    (0, 0, 255),      # 빨간색 (Red)
    (255, 255, 0),    # 청록색 (Cyan)
    (255, 0, 255),    # 마젠타색 (Magenta)
    (0, 255, 255),    # 노란색 (Yellow)
    (128, 0, 255),    # 보라색 (Purple)
    (255, 128, 0),    # 주황색 (Orange)
    (0, 128, 255),    # 하늘색 (Sky Blue)
    (128, 255, 0),    # 연두색 (Lime)
    (255, 0, 128),    # 분홍색 (Pink)
    (0, 255, 128),    # 민트색 (Mint)
    (128, 0, 128),    # 자주색 (Maroon)
]
